    ...
    <>
      ...
      <nav className={`nav ${scrolled ? 'nav--scrolled' : ''}`}>
        <div className="nav-inner">
          ...
          <a href="/api/auth/twitch" className="btn btn--primary nav-cta">Empezar gratis</a>
        ...
        <div className="container">
          ...
          <div className="pricing" id="precios">
            <div className="pricing-card">
              ...
              <a href="/api/auth/twitch" className="btn btn--ghost btn--full">Empezar gratis</a>
            </div>
            <div className="pricing-card pricing-card--pro">
              ...
              <a href="/api/auth/twitch" className="btn btn--primary btn--full">
